...
Prompt the user for confirmation before downloading a release when the cached version differs from the remote version, giving users control over when upgrades happen.
